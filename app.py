...
class WindowLoop(Functionalities, Reports_pdf, tk.Tk):
    ...
    def widgets_frame_1(self):
        ...
        # limpar
        self.btn_clear = Button(self.frame_1, text="Limpar", fg=self.TEXT_BUTTON, bg=self.BUTTON_COLOR, bd=2,
                                font=('consolas', 12, 'bold'),
                                command=self.clean_screen_login)
        self.btn_clear.place(relx=0.1, rely=0.900, relwidth=0.30, relheight=0.050)

        # apagar
        self.btn_erase = Button(self.frame_1, text="Apagar", fg=self.TEXT_BUTTON, bg=self.BUTTON_COLOR, bd=2,
                                font=('consolas', 12, 'bold'),
                                command=self.delet_login)
        self.btn_erase.place(relx=0.5, rely=0.830, relwidth=0.30, relheight=0.050)

        # alterar
        self.btn_edit = Button(self.frame_1, text="Editar", fg=self.TEXT_BUTTON, bg=self.BUTTON_COLOR, bd=2,
                               font=('consolas', 12, 'bold'),
        ...
        self.label_credits = Label(self.frame_1, text="Por Caio Madeira", bg=self.FRAME_1_COLOR,
                                   fg=self.LABEL_COLOR_TEXT,
                                   font=('helvetica', 7, 'bold'))
        self.label_credits.place(x=10, y=5, width=100, height=20)

        self.label_account = Label(self.frame_1, text="Conta:", bg=self.FRAME_1_COLOR, fg=self.LABEL_COLOR_TEXT,
    ...
    def frame_2_list(self):
        ...
        self.btn_search = Button(self.frame_2, text="Buscar", fg=self.TEXT_BUTTON, bg=self.BUTTON_COLOR, bd=2,
                                 font=('consolas', 12, 'bold'),
